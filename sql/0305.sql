...
CREATE SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_3957C8C8_5F2B_4B0C_9408_A135C1D044C1" START WITH 5 BELONGS_TO_TABLE; 
...
CREATE CACHED TABLE "PUBLIC"."STUDENT"(
    "ID" INT DEFAULT (NEXT VALUE FOR "PUBLIC"."SYSTEM_SEQUENCE_3957C8C8_5F2B_4B0C_9408_A135C1D044C1") NOT NULL NULL_TO_DEFAULT SEQUENCE "PUBLIC"."SYSTEM_SEQUENCE_3957C8C8_5F2B_4B0C_9408_A135C1D044C1",
    "LASTNAME" TEXT,
    "NAME" TEXT,
    "PATRONOMYC" TEXT,
    "GENDER" TEXT,
    ...
    "SITOTA" TEXT,
    "OPEKAEMII" TEXT,
    "WITHOUTONEPARENT" TEXT,
    "CHELLENGED1" TEXT,
    "CHELLENGED2" TEXT,
    "CHELLENGED3" TEXT,
    "BIGFAMILY" TEXT,
    "CHELLENGEDPARENTS" TEXT,
    "RETURNED" TEXT,
    "MERRIED" TEXT,
    "HAVECHILD" TEXT,
    "CHILDCOUNT" TEXT,
    ...
    "FILEPROPISKA" TEXT,
    "FILEOPLATA" TEXT,
    "FILEPOLICLINIKA" TEXT
);       
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.STUDENT;  
INSERT INTO "PUBLIC"."STUDENT" VALUES
(3, STRINGDECODE('\u0424\u0435\u0434\u043e\u0442\u043e\u0432'), STRINGDECODE('\u0418\u0432\u0430\u043d'), STRINGDECODE('\u0410\u0440\u0438\u0441\u0442\u0430\u0440\u0445\u043e\u0432\u0438\u0447'), STRINGDECODE('\u041c\u0443\u0436'), STRINGDECODE('\u0440\u0443\u0441\u0441\u043a\u0438\u0439'), '87078965423', 'ivan.a@mail.ru', '87013365984', 'fedotov.a@mail.ru', STRINGDECODE('\u041a\u0430\u0440\u0430\u0433\u0430\u043d\u0434\u0438\u043d\u0441\u043a\u0430\u044f \u043e\u0431\u043b\u0430\u0441\u0442\u044c'), STRINGDECODE('\u041a\u0430\u0440\u0430\u0433\u0430\u043d\u0434\u0430'), STRINGDECODE('\u0443\u043b. \u0414\u0435\u0440\u0431\u0435\u043d\u0435\u0432\u0441\u043a\u0430\u044f \u043d\u0430\u0431, \u0434\u043e\u043c 75, \u043a\u0432\u0430\u0440\u0442\u0438\u0440\u0430 87'), STRINGDECODE('\u0421 \u0440\u043e\u0434\u0438\u0442\u0435\u043b\u044f\u043c\u0438'), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, STRINGDECODE('\u0425\u043e\u043b\u043e\u0441\u0442'), NULL, '', STRINGDECODE('\u0414\u0430'), '1', STRINGDECODE('\u041d\u0435\u0442'), '', '-', '-', '-'),
(4, STRINGDECODE('\u0410\u0431\u0430\u0439'), STRINGDECODE('\u0415\u0440\u0493\u0430\u043b\u0438'), STRINGDECODE('\u0410\u0440\u043c\u0430\u043d\u04b1\u043b\u044b'), STRINGDECODE('\u041c\u0443\u0436'), STRINGDECODE('\u043a\u0430\u0437\u0430\u0445'), '87776549562', 'abai@mail.ru', '87779876532', 'roditel@mail.ru', STRINGDECODE('\u041a\u0430\u0440\u0430\u0433\u0430\u043d\u0434\u0438\u043d\u0441\u043a\u0430\u044f \u043e\u0431\u043b\u0430\u0441\u0442\u044c'), STRINGDECODE('\u041a\u0430\u0440\u0430\u0433\u0430\u043d\u0434\u0430'), STRINGDECODE('\u041f\u0440\u043e\u0441\u043f\u0435\u043a\u0442 \u0420\u0435\u0441\u043f\u0443\u0431\u043b\u0438\u043a\u0438 1'), STRINGDECODE('\u0421\u044a\u0435\u043c\u043d\u0430\u044f \u043a\u0432\u0430\u0440\u0442\u0438\u0440\u0430'), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'returned', STRINGDECODE('\u0425\u043e\u043b\u043e\u0441\u0442'), NULL, '', STRINGDECODE('\u0414\u0430'), '1', STRINGDECODE('\u041d\u0435\u0442'), '', '-', '-', '-');      
